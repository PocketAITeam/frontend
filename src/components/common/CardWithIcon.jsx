...
const CardWithIcon = ({ icon, title, description }) => {
    return (
        <div
            className="flex flex-col items-start border-[5px] border-white rounded-3xl md:py-9 md:px-7 py-5 px-4 md:max-w-sm w-full shadow-[0px_4px_12px_0px_rgba(0,0,0,0.1)] text-left"
            style={{
